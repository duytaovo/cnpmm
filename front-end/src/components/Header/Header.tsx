...
export default function Header() {
  ...
  return (
    <div className='bg-mainColor pb-5 pt-2 text-white'>
      <div className='container'>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <Link to='/' className='col-span-3'>
            <div className=''>
              <img src={logo} alt='logo' className='h-[65px] w-[130px] rounded-md' />
            </div>
          </Link>
                  ...
                  {purchasesInCart && purchasesInCart.length > 0 ? (
                    <div className='p-2'>
                        ...
                        {purchasesInCart.slice(0, MAX_PURCHASES).map((purchase) => (
                          <div className='mt-2 flex py-2 hover:bg-gray-100' key={purchase._id}>
                            ...
                            <div className='ml-2 flex-shrink-0'>
                              <span className='text-main'>₫{formatCurrency(purchase.product.price)}</span>
                            </div>
                          </div>
                        ))}
                      </div>
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <Link
                          to={path.cart}
                          className='rounded-sm bg-main px-4 py-2 capitalize text-white hover:bg-opacity-90'
                        >
                          Xem giỏ hàng
                        </Link>
                      </div>
